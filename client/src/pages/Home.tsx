...
function Logo() {
  return <div className="flex items-center gap-2.5"><div className="relative flex h-9 w-9 items-center justify-center rounded-[13px] bg-[#142633] shadow-[0_5px_0_#F06A3A]"><img src="/manus-storage/ridemate-mark_16a564be.png" alt="" aria-hidden="true" className="absolute inset-1 h-7 w-7 rounded-[10px] object-contain" onError={(event) => { event.currentTarget.style.display = "none"; }} /><div className="absolute left-[9px] top-[9px] h-2.5 w-2.5 rounded-full bg-[#F06A3A]" /><div className="absolute bottom-[8px] right-[8px] h-2.5 w-2.5 rounded-full border-2 border-[#F06A3A]" /><div className="absolute left-[14px] top-[14px] h-[12px] w-[2px] rotate-[42deg] bg-[#F06A3A]" /></div><span className="font-display text-[25px] font-semibold tracking-[-0.05em] text-[#142633]">RideMate</span></div>;
}
